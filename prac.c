...
#define TRAIN_HAM_PATH "csv/train/dataset_ham_train100.csv"
#define TRAIN_SPAM_PATH "csv/train/dataset_spam_train100.csv"
#define TEST_HAM_PATH "csv/test/dataset_ham_test20.csv"
#define TEST_SPAM_PATH "/csv/test/dataset_spam_test20.csv"
